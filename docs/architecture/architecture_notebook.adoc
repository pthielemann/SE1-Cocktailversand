...
=== Stakeholder 
//stellt Betriebsumgebung bereit
Webhoster, Barbetreiber, (Versanddienstleister), Benutzerumgebung (Bestellmengen, welche Anforderungen), Kunden (wo wird System genutzt, welche Endgeräte, ), Bezahldienstleister, Gesetzgeber(Datenschutz, BGB, Jugendschutz, Impressumspflicht, Fernabsatzsgesetz zB Rückgabefristen)
